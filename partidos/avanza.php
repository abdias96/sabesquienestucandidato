    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/daniloroca.php#disqus_thread" data-disqus-identifier="daniloroca">
                </a>
            ...
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/manuelmartinez.php#disqus_thread" data-disqus-identifier="manuelmartinez">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/manuelmartinez.php">
                    ...
                    <img class="img-fluid" src="../img/candidatos/manuelmartinez.PNG" alt="">
                </a>
                <div class="portfolio-caption">
