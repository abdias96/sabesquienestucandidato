    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/sandratorres.php#disqus_thread" data-disqus-identifier="sandratorres">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/sandratorres.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/sandratorres.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Sandra Julieta Torres Casanova</h4>
                    <p class="text-muted">Candidato a presidente</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/carlosmorales.php#disqus_thread" data-disqus-identifier="carlosmorales">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/carlosmorales.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/carlosmorales.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Carlos Raúl Morales Moscoso</h4>
