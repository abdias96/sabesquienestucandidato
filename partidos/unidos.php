    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/luisvelasquez.php#disqus_thread" data-disqus-identifier="luisvelasquez">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/luisvelasquez.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/luisvelasquez.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Luis Antonio Velásquez Quiroa</h4>
                    <p class="text-muted">Candidato a presidente</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/manuelsoto.php#disqus_thread" data-disqus-identifier="manuelsoto">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/manuelsoto.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/manuelsoto.PNG" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Manuel Arturo Soto Aguirre</h4>
