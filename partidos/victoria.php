    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/amilcarrivera.php#disqus_thread" data-disqus-identifier="amilcarrivera">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/amilcarrivera.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/amilcarrivera.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Amílcar Rivera Estévez</h4>
                    <p class="text-muted">Candidato a presidente</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/ericocan.php#disqus_thread" data-disqus-identifier="ericocan">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/ericocan.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/ericocan.PNG" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Erico Can Saquic</h4>
