    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/alejandrogiammatei.php#disqus_thread" data-disqus-identifier="alejandrogiammattei">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/alejandrogiammattei.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/alejandrogiammattei.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Alejandro Eduardo Giammattei Falla</h4>
                    <p class="text-muted">Candidato a presidente</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/guillermocastillo.php#disqus_thread" data-disqus-identifier="guillermocastillo">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/guillermocastillo.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/guillermocastillo.PNG" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>César Guillermo Castillo Reyes</h4>
