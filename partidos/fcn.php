    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/estuardogaldamez.php#disqus_thread" data-disqus-identifier="estuardogaldamez">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/estuardogaldamez.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/estuardogaldamez.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Estuardo Ernesto Galdámez Juárez</h4>
                    <p class="text-muted">Candidato a presidente</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/bettymarroquin.php#disqus_thread" data-disqus-identifier="bettymarroquin">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/bettymarroquin.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/bettymarroquin.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Betty Marroquín Silva</h4>
