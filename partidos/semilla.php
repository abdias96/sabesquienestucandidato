    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/thelmaaldana.php#disqus_thread" data-disqus-identifier="thelmaaldana">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/thelmaaldana.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/thelmaaldana.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Thelma Esperanza Aldana Hernández</h4>
                    <p class="text-muted">Candidato a presidente</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/jonathanmenkos.php#disqus_thread" data-disqus-identifier="jonathanmenkos">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/jonathanmenkos.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/jonathanmenkos.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Jonathan Kiril Thomas Menkos Zeissig</h4>
