    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/robertoarzu.php#disqus_thread" data-disqus-identifier="edwinescobar">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/edwinescobar.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/edwinescobar.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Edwin Felipe Escobar Hill</h4>
                    <p class="text-muted">Candidato a presidente</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/blancaalfaro.php#disqus_thread" data-disqus-identifier="blancaalfaro">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/blancaalfaro.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/blancaalfaro.PNG" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Blanca Odilia Alfaro Guerra</h4>
