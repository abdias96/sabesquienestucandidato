    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/zuryrios.php#disqus_thread" data-disqus-identifier="zuryrios">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/zuryrios.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/zuryrios.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Zury Mayté Ríos Sosa</h4>
                    <p class="text-muted">Candidato a presidente</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/robertobarreto.php#disqus_thread" data-disqus-identifier="robertobarreto">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/robertobarreto.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/robertobarreto.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Roberto Molina Barreto</h4>
