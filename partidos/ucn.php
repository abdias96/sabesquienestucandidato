    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/marioestrada.php#disqus_thread" data-disqus-identifier="marioestrada">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/marioestrada.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/marioestrada.png" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Mario Amílcar Estrada Orellana</h4>
                    <p class="text-muted">Candidato a presidente</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/javiercastillo.php#disqus_thread" data-disqus-identifier="javiercastillo">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/javiercastillo.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/javiercastillo.PNG" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Otto Javier Castillo Valenzuela</h4>
