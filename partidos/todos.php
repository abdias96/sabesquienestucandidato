    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/josecabrera.php#disqus_thread" data-disqus-identifier="josecabrera">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/josecabrera.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/josecabrera.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>José Guillermo Alfredo Cabrera Martínez</h4>
                    <p class="text-muted">Candidato a presidente</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 portfolio-item">
                <a class="portfolio-link text-center" href="https://sabesquienestucandidato.com/candidatos/ricardosagastume.php#disqus_thread" data-disqus-identifier="ricardosagastume">
                </a>
                <a class="portfolio-link text-center" href="../candidatos/ricardosagastume.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content">
                            <i class="fas fa-plus fa-3x"></i>
                        </div>
                    </div>
                    <img class="img-fluid" src="../img/candidatos/ricardosagastume.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Ricardo Sagastume Morales</h4>
