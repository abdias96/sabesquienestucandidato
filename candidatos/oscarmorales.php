...
<head>
    ...
    <title>Óscar Adolfo Morales Montúfar</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Óscar Adolfo Morales Montúfar</h2>
        ...
        <script>
            ...
            var disqus_config = function () {
                this.page.url = "https://sabesquienestucandidato.com/candidatos/oscarmorales.php";  // Replace PAGE_URL with your page's canonical URL variable
                this.page.identifier = "oscarmorales"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
            };
