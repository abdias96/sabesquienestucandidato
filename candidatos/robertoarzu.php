...
<head>
    ...
    <title>Roberto Arzú García-Granados</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ml-auto">
                ...
                <li class="nav-item">
                    <a class="js-scroll-trigger" style="display: block; padding: 0.5rem 1rem;" href="../partidos/pan.php">PAN</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Roberto Arzú García-Granados</h2>
        ...
        <script>
            ...
            var disqus_config = function () {
                this.page.url = "https://sabesquienestucandidato.com/candidatos/robertoarzu.php";  // Replace PAGE_URL with your page's canonical URL variable
                this.page.identifier = "robertoarzu"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
            };
