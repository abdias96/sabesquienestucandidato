...
<head>
    ...
    <title>Manuel Abundio Maldonado</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Manuel Abundio Maldonado</h2>
        ...
        <script>
            ...
            var disqus_config = function () {
                this.page.url = "https://sabesquienestucandidato.com/candidatos/manuelmaldonado.php";  // Replace PAGE_URL with your page's canonical URL variable
                this.page.identifier = "manuelmaldonado"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
            };
