...
<head>
    ...
    <title>Jonathan Kiril Thomas Menkos Zeissig</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Jonathan Kiril Thomas Menkos Zeissig</h2>
        ...
        <div class="row text-center">
            <div class="col-md-12 comment">
                ...
                <h4 class="service-heading">Carrera profesional</h4>
                <p class="text-muted" style="text-align: justify;">
                    Menkos es presidente del Instituto Centroamericano de Estudios Fiscales (ICEFI) desde septiembre de 2012, 2​ el 5 de marzo de 2019, el Consejo Directivo del Instituto anunció que Menkos había pedido una licencia para ser ausentarse de sus deberes como Presidente de IECFI desde el 1 de marzo al 15 de agosto de 2019. Horas más tarde, el Partido Semilla, anunciaba que Jonathan Menkos había sido elegido para acompañar, como segundo, a la candidata presidencial Thelma Aldana en las próximas elecciones generales.
                </p>
            </div>
        </div>
        ...
        <script>
            ...
            var disqus_config = function () {
                this.page.url = "https://sabesquienestucandidato.com/candidatos/jonathanmenkos.php";  // Replace PAGE_URL with your page's canonical URL variable
                this.page.identifier = "jonathanmenkos"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
            };
