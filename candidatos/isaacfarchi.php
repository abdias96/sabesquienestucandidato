...
<head>
    ...
    <title>Isaac Farchi Sultán</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Isaac Farchi Sultán</h2>
        ...
        <script>
            ...
            var disqus_config = function () {
                this.page.url = "https://sabesquienestucandidato.com/candidatos/isaacfarchi.php";  // Replace PAGE_URL with your page's canonical URL variable
                this.page.identifier = "isaacfarchi"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
            };
